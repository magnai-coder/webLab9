...
const newModel = new mongoose.model('collection', taskSchema)
const data = async()=>{
    const result = await newModel.insertMany([{day: "Мягмар", time: 1, className: "Програмчлалын хэлний зарчимууд" ,classType: "Лекц", roomNumber: 214},
...
data();
const newModel2 = new mongoose.model('tasks', taskSchema)
const data2 = async()=>{
...
module.exports = {Task, EmployeeModel};
